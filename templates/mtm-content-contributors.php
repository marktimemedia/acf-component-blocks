	...
	<div class="mtm-component--content mtm-user-picker">
		...
		$authorlink = $userpost > 0 ? true : false ?>
			<div class="mtm-user-picker--user <?php echo $mtm_grid_row_class; ?>">
				<?php if( $authorlink ) { echo '<a href="' . esc_url( get_author_posts_url( $user['ID'] ) ) .'">'; } ?><figure><?php echo get_avatar( $user['ID'], 512 ); // outputs complete image tag ?></figure><?php if( $authorlink ) { echo '</a>'; } ?>
