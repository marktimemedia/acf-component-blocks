...
<div class="content--inner">
	...
	if( get_field( 'mtm_module_text_area' ) ) : ?>
		<div class="mtm-module--content-primary"><?php the_field( 'mtm_module_text_area' ) ?></div>
	<?php endif;
	...
	if( get_field( 'mtm_module_text_area_2' ) ) :
		...
		<?php else : ?>
			<div class="mtm-module--content-secondary"><?php the_field( 'mtm_module_text_area_2' ) ?></div>
		<?php endif;
	endif; ?>
</div>
