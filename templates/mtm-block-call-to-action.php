...
<div class="content--inner">
	<section class="mtm-module--cta">
		<?php if( get_field( 'mtm_cta_headline' ) ) : ?>
			<h2 class="mtm-module--cta-heading mtm-module-title"><?php the_field( 'mtm_cta_headline' ); ?></h2>
		<?php endif;
		if( get_field( 'mtm_cta_subheading' ) ) : ?>
			<div class="mtm-module--cta-subheading"><?php the_field( 'mtm_cta_subheading' ); ?></div>
		<?php endif;
