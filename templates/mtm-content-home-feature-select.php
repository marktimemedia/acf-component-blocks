...
<div class="mtm-home-featured--single <?php echo mtm_count_classes( $mtm_home_feature_count ) ?>">
	<div class="mtm-home-featured--single-content">
		...
		<div class="mtm-home-featured--single-text">
			<h3 class="mtm-home-featured--single-title"><a href="<?php the_permalink(); ?>"><?php if( "Post Title" == _get_sub_field( 'mtm_home_featured_box_title' ) ) { the_title();} else { esc_html( the_sub_field( 'mtm_home_featured_box_title' ) ); } ?></a></h3>
			<?php the_excerpt(); ?>
		</div>
	</div>
</div>
